//! FFI request/response shapes for [`dwn_rs_agent::auth::connect`] flows.
//!
...
use dwn_rs_agent::agent::PortableDid;
use dwn_rs_agent::auth::connect::{ConnectPermissionRequest, DelegateGrant};
